...
public class TagFlowLayout extends FlowLayout implements TagAdapter.OnDataChangedListener {
    ...
    private ArrayList<Integer> mCanNotSelectList = new ArrayList<>();
    ...
    public void setOnSelectListener(OnSelectListener onSelectListener) {
        ...
        if (mOnSelectListener != null && clickable) {
            setClickable(true);
        } else {
            setClickable(false);
        }
    ...
    public void setTagIsClickable(boolean clickable) {
    ...
    public void setOnTagClickListener(OnTagClickListener onTagClickListener) {
        ...
        if (onTagClickListener != null && clickable) {
            setClickable(true);
        } else {
            setClickable(false);
        }
...
//            lp.rightMargin = clp.rightMargin;
    ...
    public boolean performClick() {
        ...
        if (child != null) {
            boolean canDoSelect = true;
            for (int canNotSelectPosition : mCanNotSelectList) {
                if (canNotSelectPosition == pos){
                    canDoSelect = false;
                }
            }
    ...
    public void setCanNotSelectPosition(ArrayList<Integer> list){
        mCanNotSelectList.addAll(list);
    }
    public void clearList(){
        mCanNotSelectList.clear();
    }
